...
//#ifdef TENSORFLOW_USE_FPGA
	void set_fpga_wrapper_device(FPGAWrapper* d) { fpga_wrapper_device_ = d; }
//#endif
...
//#ifdef TENSORFLOW_USE_FPGA
	const FPGAWrapper* fpga_wrapper_device() const {
	  CHECK(fpga_wrapper_device_ != nullptr);
	  return fpga_wrapper_device_;
	}
//#endif
...
#endif
//#ifdef TENSORFLOW_USE_FPGA
  FPGAWrapper* fpga_wrapper_device_ = nullptr;
//#endif
